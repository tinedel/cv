...
\cventry{March 2021--Present}{Lead Software Engineer}{EPAM Systems}{Amsterdam (WFH)}{}{
  ...
  the future of financial and other sectors of economy. I was one of the first EPAM's engineers to joing their team and
  I actively engaged with the client to create more demand for EPAM's services.
...
\cventry{Feb 2020--Feb 2021}{Lead Software Engineer}{EPAM Systems}{Krakow}{}{
  ...
  \begin{itemize}
    ...
    \item Mentored engineers from my team and lead them through the internal assesment process which resulted in promotion for both of them.
    \item Built load testing framework based on Gatling to verify if system we are building will be able to perform accoreing to the expected SLAs.
    \item Team has completed extraction of two microservices out of monolithic, poorly documented project. Resulting microservices had good coverage and adhered to code standards
    \item Worked with other team leads to discuss interface, architecture decision and to be sure dependencies are met or timely noted as risks.
    \item Gave input to the scrum master when needed to impove process quality. E.g. proposed to vary retrospectives to collect team's feadback from different perspectives.
  \end{itemize}
